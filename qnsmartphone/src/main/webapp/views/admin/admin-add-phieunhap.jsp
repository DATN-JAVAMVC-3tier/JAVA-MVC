		...
		<h3 class="text-center">Phiếu Nhập Hàng</h3>
				...
				<div class="form-row">
					...
					<select class="bg-success form-control  text-white col-12 mt-2" name="nhacungung" >
				        ...
				        <option value='A123'>[A123]Công ty VN SMART</option>
							<option value='M2422'>[M2422]Công ty TNHH VN Phone</option>
							<option value='M224'>[M224]Công ty NVC Phone</option>
							<option value='A22'>[A22]Công ty TNHH Phân phối VIỆT PHÁT</option>
