...
<c:if test="${not empty issort}">
<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12">
			<h3 class="main_title_left" >
				<em></em>
				<span style="color:#fff; background-color: #da7227;padding:5px;">tìm thấy <c:out value="${listsanphamsort.size() }" /> kết quả phù hợp</span>
			</h3>
		</div>
		
		<c:if test="${not empty listsanphamsort}">
		<c:forEach items="${listsanphamsort}" var="product">
			<!-- item -->
